...
6. 用一个需求来体验 axios 语法的使用，从服务器获取省份列表数据，展示到页面上
   ...
   * 完成效果：
     ...
     ![image-20230220113157010](https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/hm8.1ajax/image-20230220113157010.png)
...
7. 接下来做个需求，访问新闻列表的 URL 网址，打印新闻数据
   ...
   * 效果图如下：
   ...
   ![image-20230220122455915](https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/hm8.1ajax/image-20230220122455915.png)
...
3. axios 如何携带查询参数?
   ...
   * 使用 params 选项即可、
     ...
     ![image-20230220124958792](https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/hm8.1ajax/image-20230220124958792.png)
...
1. 需求：根据输入的省份名字和城市名字，查询下属地区列表
   ...
   * 完成效果如下：
     ...
     ![image-20230220125428695](https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/hm8.1ajax/image-20230220125428695.png)
...
1. 想要提交数据，先来了什么是请求方法
   ...
   * 请求方法是一些固定单词的英文，例如：GET，POST，PUT，DELETE，PATCH（这些都是http协议规定的），每个单词对应一种对服务器资源要执行的操作
     ...
     ![image-20230220130833363](https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/hm8.1ajax/image-20230220130833363.png)
...
3. axios 如何提交数据到服务器呢？
   ...
   * 需要学习，method 和 data 这2个新的选项了（大家不用担心，这2个学完，axios常用的选项就都学完了）
     ...
     ![image-20230220131058168](https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/hm8.1ajax/image-20230220131058168.png)
...
1. 如果注册相同的用户名，则会遇到注册失败的请求，也就是 axios 请求响应失败了，你会在控制台看到如图的错误：
   ...
   ![image-20230220131753051](https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/hm8.1ajax/image-20230220131753051.png)
...
3. 使用 axios 的 catch 方法，捕获这次请求响应的错误并做后续处理，语法如下：
   ...
   ![image-20230220131911928](https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/hm8.1ajax/image-20230220131911928.png)
...
2. 请求报文：是浏览器按照协议规定发送给服务器的内容，例如刚刚注册用户时，发起的请求报文：
   ...
   ![image-20230220132229960](https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/hm8.1ajax/image-20230220132229960.png)
...
3. 通过 Chrome 的网络面板如何查看请求体？
   ...
   ![image-20230220132617016](https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/hm8.1ajax/image-20230220132617016.png)
...
1. 响应报文：是服务器按照协议固定的格式，返回给浏览器的内容
   ...
   ![image-20230220133141151](https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/hm8.1ajax/image-20230220133141151.png)
...
3. HTTP 响应状态码：
   ...
   * 例如：404（服务器找不到资源）
     ...
     ![image-20230220133344116](https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/hm8.1ajax/image-20230220133344116.png)
